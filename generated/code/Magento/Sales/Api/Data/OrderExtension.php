...
class OrderExtension extends \Magento\Framework\Api\AbstractSimpleObject implements OrderExtensionInterface
{
     ...
     * @return string|null
     */
    public function getUmOrderComment()
    {
        return $this->_get('um_order_comment');
    }

    /**
     * @param string $umOrderComment
     * @return $this
     */
    public function setUmOrderComment($umOrderComment)
    {
        $this->setData('um_order_comment', $umOrderComment);
        return $this;
    }
}
