...
class Interceptor extends \Magento\InventoryConfigurableProductAdminUi\Block\Adminhtml\Product\Steps\Bulk implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getCaption()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getCaption', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getNoImageUrl()
    {
        ...
        if (!$pluginInfo) {
            return parent::getNoImageUrl();
        } else {
            return $this->___callPlugins('getNoImageUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getImageTypes()
    {
        ...
        if (!$pluginInfo) {
            return parent::getImageTypes();
        } else {
            return $this->___callPlugins('getImageTypes', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getParentComponentName()
    {
        ...
        if (!$pluginInfo) {
            return parent::getParentComponentName();
        } else {
            return $this->___callPlugins('getParentComponentName', func_get_args(), $pluginInfo);
        }
    }
